<p align="center">
  ...
  <b>Нам потрібна ваша допомога для перекладу цього README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">інтерфейсу</a> та <a href="https://github.com/rustdesk/doc.free.rustdesk.v6.pub">документації</a> RustDesk вашою рідною мовою</B>
</p>
...
## [Збирання](https://free.rustdesk.v6.pub/docs/en/dev/build/)
