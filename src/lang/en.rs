...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("doc_mac_permission", "https://free.rustdesk.v6.pub/docs/en/client/mac/#enable-permissions"),
        ...
        ("doc_fix_wayland", "https://free.rustdesk.v6.pub/docs/en/client/linux/#x11-required"),
